...
const steps = [
  { title: 'Understand', description: 'Assess organizational needs and skill gaps.' },
  { title: 'Customize', description: 'Design tailored programs aligned with business objectives.' },
  { title: 'Engage', description: 'Interactive learning through role plays and simulations.' },
  { title: 'Reflect', description: 'Participants analyze learning and develop action plans.' },
  { title: 'Apply', description: 'Practical implementation that drives performance improvement.' },
];

const experienceCategories = [
  {
    title: 'Experiential Learning',
    items: ['Management Games', 'Outbound Training Programs', 'Business Simulations'],
  },
  {
    title: 'Interactive Skill Building',
    items: ['Role Plays', 'Group Activities', 'Presentations'],
  },
  {
    title: 'Career Preparation',
    items: ['Mock Interviews', 'Group Discussion Training', 'Industry-Specific Interview Preparation'],
  },
];
...
const whyChooseUs = [
  ...
  'Strong academia-industry connection',
  'Leadership and behavioral capability development',
  'Placement mentoring and career readiness support',
];
  ...
  <section id="training" className="section-padding bg-background w-full">
    <div className="max-w-7xl mx-auto px-6">
      ...
      >
        ...
        <h2 className="section-heading mb-6 tracking-tighter">Training Methodology</h2>
        <p className="section-subheading max-w-2xl bg-gradient-to-r from-muted-foreground to-foreground bg-clip-text text-transparent font-medium">
          A structured approach combining experiential learning, industry alignment, and continuous performance evaluation.
        </p>
      </motion.div>
      ...
      <div className="grid lg:grid-cols-12 gap-12 mb-32 items-start">
        <div className="lg:col-span-4 sticky top-32">
          <div className="p-8 bg-secondary/30 rounded-3xl border border-primary/10">
            <h3 className="font-display font-bold text-2xl text-foreground mb-6">Our 5-Step Process</h3>
            <p className="text-muted-foreground text-sm leading-relaxed mb-8">
              We follow a rigorous methodology to ensure that every training program delivers measurable impact and sustainable results.
            </p>
      ...
      <div className="mb-32">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            ...
            <h3 className="font-display font-bold text-3xl text-foreground">Training Experience & Tools</h3>
          </div>
        </div>
        ...
        <div className="bg-primary-foreground/5 rounded-[1.9rem] p-12 md:p-20 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h3 className="font-display font-bold text-4xl md:text-5xl text-white mb-8 tracking-tighter leading-tight">
              Why Organizations <br className="hidden md:block" /> 
              <span className="text-white/40">Choose Our Approach.</span>
            </h3>
            <p className="text-white/60 text-lg leading-relaxed max-w-md">
              We bridge the gap between academic theory and industry reality through precision-engineered training programs.
            </p>
          </div>
