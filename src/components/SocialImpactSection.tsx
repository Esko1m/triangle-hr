      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="section-heading mb-8">{impact.title}</h2>
          ...
          >
            <div className="card-elevated p-10 md:p-12 relative overflow-hidden group">
              ...
              <div className="flex items-center gap-5 mb-10">
                ...
                <h3 className="text-2xl font-bold font-display text-foreground">{impact.focusTitle}</h3>
              </div>
              
              <ul className="space-y-6">
                {impact.initiatives.map((item, i) => (
